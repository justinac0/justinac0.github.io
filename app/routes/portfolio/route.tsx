...
export const loader = async () => {
    return json([
        ...
        { title: "Water Diffuse in Collagen", description: "Proof of concept simulation of bulk water diffusion inside a collagen fibre network (in the radial zone).", image: "/portfolio/collagen.gif", ghLink: "https://github.com/justinac0/CollagenPrototype" },
